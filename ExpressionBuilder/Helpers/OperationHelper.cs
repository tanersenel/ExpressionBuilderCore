...
using ExpressionBuilderCore.Configuration;
using ExpressionBuilderCore.Exceptions;
    ...
    public class OperationHelper : IOperationHelper
    {
        ...
        public static void LoadDefaultOperations()
        {
            ...
            var operationsFound = AppDomain.CurrentDomain.GetAssemblies()
                .Where(a => a.DefinedTypes.Any(t => t.Namespace == "ExpressionBuilderCore.Operations"))
